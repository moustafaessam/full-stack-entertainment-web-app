...
This project is a full-stack entertainment web application that allows users to explore movies and TV series. Users can search for content, view trending and recommended titles, and bookmark their favorite movies or TV shows. The application is built using a modern stack including **React**, **TypeScript**, **Vite**, **Styled Components**, **React Query**, and **Supabase** for backend services, authentication, and database management.
...
- Each page provides a real-time search feature, allowing users to search for movies or TV series.
...
- **Vite:** A fast build tool that improves development speed and efficiency.
